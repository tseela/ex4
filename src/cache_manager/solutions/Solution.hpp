...
public:
     ...
     * 
     */
    void writeToOutputFile(Problem* problem) const;
     ...
     */
    void writeToOutputFile(Problem* problem, const std::string& content) const;
     ...
     */
    virtual void writeToFile(Problem* problem, const std::string& fileName) const = 0;

    virtual std::string getSolutionString(Problem* problem) const;
